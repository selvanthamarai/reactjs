...
import { user, manager,viewAndApprove} from '../constant/tableconstant';
        ...
        <TableBody>
          {post.length > 0 && post.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map(row => (
            <TableRow key={row.id}>
              ...
              {props.prop.location.state && props.prop.location.state.type === manager | props.prop.location.state.type === viewAndApprove &&
                <Fragment>
                  <TableCell>
