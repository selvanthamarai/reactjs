        ...
        <div className={classes.paper}>
          ...
          <form className={classes.form} onSubmit={submitHandler}>
            ...
            <Textfield name="empname" id="empname" label="Name" autoComplete="name" variant="outlined" sms="6" autof={false} value={values.empname} onchange={changeHandler} />
              <Textfield name="leavereason" id="leavereason" label="Leave Reason" autoComplete="lreason" variant="outlined" sms="false" autof={false} value={values.leavereason} onchange={changeHandler} />
              ...
              <OptionField getValue={getValue} values={["Sick","Personal","Casual"]}  label="Leave Type"/>
              <Grid item xs={12}>
                <FormControlLabel
