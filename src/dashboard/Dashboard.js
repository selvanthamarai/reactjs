...
//import CustomTablePagination1 from '../components/TablePagination/CustomTablePagination1'
                ...
                <div>
                  {(function () {
                    switch (state.location.state && state.location.state.type) {
                      case 'Manager':
                        return <CustomTablePagination label={["Approve","Reject"]} prop={props} />;

                      case 'Leave Application':
                        return <LeavePage prop={props} />;
                      case 'User':
                        return <CustomTablePagination label={false}prop={props} />;
                      case 'Expenses':
                        return <CustomTablePagination label={false}prop={props} />;
                        case 'View And Approve':
                          return <CustomTablePagination label={["View","Approve"]} prop={props} />;
                      default:
                        return null;
                    }
                  })()}
